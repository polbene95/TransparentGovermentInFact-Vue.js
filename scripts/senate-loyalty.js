    ...
    methods: {
        getData: function () {
            $.getJSON(this.url, function (data) {
                senateLoyalty.members = data.results[0].members;
                senateLoyalty.allMembers = senateLoyalty.members;
                senateLoyalty.canShowAdvice = true;
                senateLoyalty.mainInfo();
                senateLoyalty.leastEngaged();
                senateLoyalty.mostEngaged();
            });
        },
        mainInfo: function () {
